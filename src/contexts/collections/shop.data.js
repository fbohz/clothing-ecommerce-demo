...
export const SHOP_DATA =  {
  memorabilia: {
      ...
      items: [
        ...
        {
          id: 2,
          name: 'Ponyo Plush Doll + Magazine',
          imageUrl: 'https://i.ibb.co/Kx3KwNd/ponyotoy.jpg',
          price: 15
        },
        {
          id: 3,
          name: 'Spirit Away Minimalist Poster',
          imageUrl: 'https://i.ibb.co/BthCNGX/Ghibli-Spirited-Posteritty-Minimal.jpg',
          price: 10
        },
        {
          id: 4,
        ...
        {
          id: 5,
          name: 'Totoro 3 in 1 Blanket + Pillow',
          imageUrl: 'https://i.ibb.co/Wc8LKmw/Plush-Totoro-Cute-Soft-Flannel-Pillow-with-Blanket-3-In-1-Stuffed-Hand-Warmer.png',
          price: 18
        },
        {
          id: 6,
        ...
        {
          id: 7,
          name: 'Castle In the Sky Lego Set',
          imageUrl: 'https://i.ibb.co/7Gs1FSy/castle-sky-lego-set.jpg',
          price: 16
        },
        {
          id: 8,
          name: 'Jiji Phone Case (Kiki Delivery Service)',
          imageUrl: 'https://i.ibb.co/Rjz5k0J/jiji-phone-case.jpg',
          price: 9
        },
        {
          id: 9,
